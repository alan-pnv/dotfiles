...
alias torbrowser='sh /home/alan/.tor-browser-linux64-9.0.10_en-US/tor-browser_en-US/Browser/start-tor-browser'
alias mnt='sudo mount -o rw,uid=1000,gid=985,exec'
PS1='[\u@\h \W]\$ '
#!/bin/sh
...
bash_prompt() {
	...
	local L_GREEN1="\[\033[0;175;0;74m\]"
...
export GOPATH=$GOPATH:$HOME/my_go
### EOF ###
